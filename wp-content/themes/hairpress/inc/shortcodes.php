...
/**
 * Shortcodes for Hairpress WP theme defined
 */


// fix for the auto-generated <p> tags
...
function sc_social_icons( $atts ) {
	...
	return '<a class="social-icon ' . $service . '" href="' . $url . '"><span class="inactive"></span></a>';
}
add_shortcode( "social_icon", "sc_social_icons" );
...
function sc_divider( $atts ) {
    ...
    if ( 'theme' == $type ) {
        $type = ot_get_option( 'content_divider', 'scissors' );
    }
